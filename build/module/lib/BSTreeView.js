...
import { EVENT_DESTROYED, EVENT_INITIALIZED, EVENT_LOADING, EVENT_LOADING_FAILED, EVENT_NODE_CHECKED, EVENT_NODE_COLLAPSED, EVENT_NODE_DISABLED, EVENT_NODE_ENABLED, EVENT_NODE_EXPANDED, EVENT_NODE_RENDERED, EVENT_NODE_SELECTED, EVENT_NODE_UNCHECKED, EVENT_NODE_UNSELECTED, EVENT_RENDERED, EVENT_SEARCH_CLEARED, EVENT_SEARCH_COMPLETED, } from './BSTreeViewEventNames';
...
export default class BSTreeView {
     ...
     */
    _domToNode(target) {
        const nodeElement = target.closest(Template.node.tagName + "." + Template.node.className.replace(" ", "."));
    ...
    _render() {
        if (!this._initialized) {
            ...
            this._wrapper = Template.tree.cloneNode(true);
     ...
     */
    addNode(nodes, parentNode = null, index = null, options = new BSTreeViewMethodOptions()) {
        if (!(nodes instanceof Array)) {
            nodes = [nodes];
        }
    ...
    /**
     ...
     @param {optional Object} options
     */
    addNodeAfter(nodes, node, options = new BSTreeViewMethodOptions()) {
        if (!(nodes instanceof Array)) {
            nodes = [nodes];
        }
    ...
    /**
     ...
     @param {optional Object} options
     */
    addNodeBefore(nodes, node, options = new BSTreeViewMethodOptions()) {
        if (!(nodes instanceof Array)) {
            nodes = [nodes];
        }
        if (node instanceof Array) {
    ...
    _options = new BSTreeViewMethodOptions()) {
        if (!(nodes instanceof Array)) {
            nodes = [nodes];
        }
        let targetNodes;
    ...
    /**
     ...
     @param {optional Object} options
     */
    selectNode(nodes, options = new BSTreeViewSelectOptions()) {
        if (!(nodes instanceof Array)) {
            nodes = [nodes];
        }
        nodes.forEach((node) => {
    ...
    /**
     ...
     @param {optional Object} options
     */
    unselectNode(nodes, options = new BSTreeViewSelectOptions()) {
        if (!(nodes instanceof Array)) {
            nodes = [nodes];
        }
        nodes.forEach((node) => {
     ...
     * @param options
     */
    selectAll(options = new BSTreeViewSelectOptions()) {
        this._orderedNodes.forEach((node) => {
     ...
     * @param options
     */
    unselectAll(options = new BSTreeViewSelectOptions()) {
        this._orderedNodes.forEach((node) => {
            if (node.state.selected) {
                node.setSelected(false, options);
            }
    ...
    /**
     ...
     @param {optional Object} options
     */
    toggleNodeSelected(nodes, options = new BSTreeViewSelectOptions()) {
        if (!(nodes instanceof Array)) {
            nodes = [nodes];
        }
        nodes.forEach((node) => {
    ...
    /**
     ...
     @param {optional Object} options
     */
    collapseAll(options = new BSTreeViewExpandOptions()) {
    ...
    /**
     ...
     @param {optional Object} options
     */
    collapseNode(nodes, options = new BSTreeViewExpandOptions()) {
        if (!(nodes instanceof Array)) {
            nodes = [nodes];
        }
        nodes.forEach((node) => {
    ...
    /**
     ...
     @param {optional Object} options
     */
    expandAll(options = new BSTreeViewExpandOptions()) {
        options.levels = options.levels || 999;
    ...
    /**
     ...
     @param {optional Object} options
     */
    expandNode(nodes, options = new BSTreeViewExpandOptions()) {
        if (!(nodes instanceof Array)) {
            nodes = [nodes];
        }
        nodes.forEach((node) => {
     ...
     * @param options
     */
    _expandLevels(nodes, level, options = new BSTreeViewExpandOptions()) {
        if (!(nodes instanceof Array)) {
            nodes = [nodes];
        }
        nodes.forEach((node) => {
    ...
    /**
     ...
     @param {optional Object} options
     */
    revealNode(nodes, options = new BSTreeViewExpandOptions()) {
        if (!(nodes instanceof Array)) {
            nodes = [nodes];
        }
        nodes.forEach((node) => {
    ...
    /**
     ...
     @param {optional Object} options
     */
    toggleNodeExpanded(nodes, options = new BSTreeViewExpandOptions()) {
        if (!(nodes instanceof Array)) {
            nodes = [nodes];
        }
        nodes.forEach((node) => {
    ...
    /**
     ...
     @param {optional Object} options
     */
    checkAll(options = new BSTreeViewMethodOptions()) {
        this._orderedNodes.forEach((node) => {
            if (!node.state.checked) {
    ...
    /**
     ...
     @param {optional Object} options
     */
    checkNode(nodes, options = new BSTreeViewMethodOptions()) {
        if (!(nodes instanceof Array)) {
            nodes = [nodes];
        }
        nodes.forEach((node) => {
    ...
    /**
     ...
     @param {optional Object} options
     */
    uncheckAll(options = new BSTreeViewMethodOptions()) {
        this._orderedNodes.forEach((node) => {
    ...
    /**
     ...
     @param {optional Object} options
     */
    uncheckNode(nodes, options = new BSTreeViewMethodOptions()) {
        if (!(nodes instanceof Array)) {
            nodes = [nodes];
        }
        nodes.forEach((node) => {
    ...
    /**
     ...
     @param {optional Object} options
     */
    toggleNodeChecked(nodes, options = new BSTreeViewMethodOptions()) {
        if (!(nodes instanceof Array)) {
            nodes = [nodes];
        }
        nodes.forEach((node) => {
    ...
    /**
     ...
     @param {optional Object} options
     */
    disableAll(options = new BSTreeViewDisableOptions()) {
    ...
    /**
     ...
     @param {optional Object} options
     */
    disableNode(nodes, options = new BSTreeViewDisableOptions()) {
        if (!(nodes instanceof Array)) {
            nodes = [nodes];
        }
        nodes.forEach((node) => {
    ...
    /**
     ...
     @param {optional Object} options
     */
    enableAll(options = new BSTreeViewDisableOptions()) {
    ...
    /**
     ...
     @param {optional Object} options
     */
    enableNode(nodes, options = new BSTreeViewDisableOptions()) {
        if (!(nodes instanceof Array)) {
            nodes = [nodes];
        }
        nodes.forEach((node) => {
    ...
    /**
     ...
     @param {optional Object} options
     */
    toggleNodeDisabled(nodes, options = new BSTreeViewDisableOptions()) {
        if (!(nodes instanceof Array)) {
            nodes = [nodes];
        }
        nodes.forEach((node) => {
     ...
     */
    search(pattern, options = new BSTreeSearchOptions()) {
     ...
     */
    clearSearch(options = new BSTreeSearchOptions()) {
